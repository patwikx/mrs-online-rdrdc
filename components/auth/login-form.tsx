      ...
      <div className="hidden lg:flex lg:w-7/12 bg-transparent p-8 xl:p-16 flex-col justify-center items-center relative z-10">
        <div className="relative w-full max-w-lg flex flex-col items-center">
          ...
          <div className="text-center">
            <h1 className="text-white text-4xl font-bold mb-3">Material Requisition System</h1>
            <p className="text-gray-400 text-base">RD Realty Development Corporation</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-5/12 bg-black/95 backdrop-blur-sm flex items-center justify-center p-6 lg:p-8 relative z-10 border-l border-gray-900/50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <div className="text-center">
              <h1 className="text-gray-50 text-xl font-bold">Material Requisition System</h1>
              <p className="text-gray-500 text-xs">RD Realty Development Corporation</p>
            </div>
          </div>
