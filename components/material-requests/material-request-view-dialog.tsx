            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>{request.requestedBy.firstName} {request.requestedBy.lastName}</p>
                ...
                {request.recApprover && (
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p>{request.recApprover.firstName} {request.recApprover.lastName}</p>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p>{request.finalApprover.firstName} {request.finalApprover.lastName}</p>
